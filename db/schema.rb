...
ActiveRecord::Schema.define(version: 20141004074958) do
  ...
  add_index "v1_sellers", ["reset_password_token"], name: "index_v1_sellers_on_reset_password_token", unique: true, using: :btree
